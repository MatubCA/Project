    ...
    <form class="form-horizontal col-md-offset-3" id="login_form" action="<%= request.getContextPath()%>/account?method=login" method="post">
      ...
      <div class="col-md-9">
        <div class="form-group">
          ...
          <span style="color: red;font-size: 13px;margin-left: -17px;"><%= request.getAttribute("usernameError")%></span>
          <%--requird自动进行非空校验--%>
          <input class="form-control required" required placeholder="请输入用户名" type="text" name="username"/>
        </div>
        <div class="form-group">
          <i class="fa fa-lock fa-lg"></i>
          <span style="color: red;font-size: 13px;margin-left: -17px;"><%= request.getAttribute("passwordError")%></span>
